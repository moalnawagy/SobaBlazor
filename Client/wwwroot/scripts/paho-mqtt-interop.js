const mqttAssemblyName = "SobaBlazor.Client";
const mqttNamespace = "SobaBlazor.Client.JsInterop";
...
window.mqttFunctions = {
    ...
    createClient: function (wsHost, wsPort, clientId) {
        ...
        pahoClient.onMessageArrived = function (message) {
            ...
            DotNet.invokeMethodAsync(mqttAssemblyName, "OnMessageReceivedHandler",message.destinationName, message.payloadString)
                .then(data => {
                    console.log(data);
                });
